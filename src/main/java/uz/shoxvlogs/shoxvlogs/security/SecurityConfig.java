...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/new/search/**").permitAll()
                .antMatchers(HttpMethod.GET, "/api/new/search").permitAll()

                .antMatchers(HttpMethod.GET, "/api/onlinenew").permitAll()
                .antMatchers(HttpMethod.GET, "/api/onlinenew/true").permitAll()
                .antMatchers(HttpMethod.GET, "/api/onlinenew/false").permitAll()
...
// 		Add a filter to validate the tokens with every request
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("https://www.shoxvlogs.uz");
        config.addAllowedOrigin("https://api.shoxvlogs.uz");
        config.addAllowedOrigin("https://www.api.shoxvlogs.uz");
        config.addAllowedOrigin("https://admin.shoxvlogs.uz");
        config.addAllowedOrigin("https://www.admin.shoxvlogs.uz");
